...
seo:
  title: "Récapitulatif du mois d'avril 2024"
  description: "Nous revenons sur le travail effectué au cours du mois d'avril : première version de notre plateforme de gestion des membres. Focus sur la gestion des organisations et sur l'usage de Floating UI"
tldr: "Au mois d'avril, nous avons principalement consacré notre temps à achever la première version d'Heimdall, notre plateforme de gestion des utilisateurs."
---
...
<Image
  ...
  alt="Input d'upload de fichier"
  title="Input d'upload de fichier"
  width={864}
  height={350}
  quality={100}
  style={{
...
<Image
  ...
  alt="Composants développés avec Floating UI"
  title="Composants développés avec Floating UI"
  width={864}
  height={350}
  quality={100}
  style={{
...
- `shift` qui permet de décentrer la bulle par rapport à l'élément cible si elle dépasse de l'écran.
