...
Dans une situation à 100% fonds propres, on doit être plus pragmatiques et trouver rapidement notre marché. Difficile, donc, de justifier passer 6 mois à design et coder sans garantie de résultats.
...
- **API ouverte :** nous allons ouvrir l'API pour laisser l'opportunité de créer des webhook et donner la possibilité de récupérer les modèles stockés dans Dédale dans des automatisations [Zapier](https://zapier.com/), [n8n](https://n8n.io/), [make](https://www.make.com/) etc.
...
- prise en main de la librairie Tiptap qui permet de créer un éditeur de texte personalisé
...
### Focus sur : la création d'un éditeur de texte avec des éléments visuels et intéractifs
