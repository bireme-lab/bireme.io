...
tldr: "Pour le mois d'octobre, nous nous sommes concentré sur Dédale, notre éditeur d'emails. Nous avons décidé de faire évoluer le produit vers une solution plus accessible avec un éditeur visuel inspiré de Figma et Notion, tout en préparant le passage à un modèle payant."
---
