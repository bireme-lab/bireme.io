...
seo:
  title: "Récapitulatif du mois d'octobre 2024"
  description: "Découvrez le récapitulatif d'octobre 2024 chez Bireme Lab : recentrage stratégique majeur de Dédale, qui devient une marque distincte avec un nouveau modèle économique. Une refonte UI/UX approfondie avec un système de cartes bento et développement d'un éditeur visuel d'emails inspiré de Figma et Notion."
tldr: "En octobre 2024, nous avons recentré notre stratégie chez Bireme Lab en nous concentrant sur Dédale, notre éditeur d'emails. Nous avons décidé de faire évoluer le produit vers une solution plus accessible avec un éditeur visuel inspiré de Figma et Notion, tout en préparant le passage à un modèle payant. Les développements techniques se sont focalisés sur l'intégration de Tiptap pour l'éditeur visuel. En parallèle, nous avons travaillé sur une nouvelle landing page avec un design soigné, utilisant notamment des effets de lumière et des cartes bento."
---
