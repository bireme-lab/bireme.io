...
## Récapitulatif du travail effectué lié aux choix stratégiques, au marketing et à la communication
...
- [Rust](https://www.rust-lang.org/) pour le back-end avec les librairies:
    - [Rocket](https://rocket.rs/) qui permet de créer un serveur web
