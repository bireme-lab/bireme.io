...
seo:
  title: "Monthly recap for august 2024"
  description: "In August we worked on our communications, the development of Hermes, an RGPD emailing tool, and the redesign of Dédale to better target developers."
tldr: "In August 2024, we optimized our content strategy on X (Twitter), achieving 65,000 impressions and 200 new subscribers, while LinkedIn slowed down due to the vacations. On the product side, we launched the design of Hermes, a contact management-focused, RGPD-compliant emailing tool, while making progress on the redesign of the Dédale website. The technical aspects focused on integrating AWS SES to track email deliverability."
---
...
### Focus on : RGPD and product design
...
We discovered, via exchanges on Twitter and in visio with personalities from the French digital universe, that no known emailing solution complies 100% with the legal obligations of the RGPD:
...
With Bireme Lab, we want to offer a 100% RGPD regulatory solution, data protection-oriented from the outset, based and managed in France.
...
#### Contact import functionality and RGPD

An example of functionality that required RGPD to be integrated into its design: importing contacts.
...
> We validated this decision after discussing RGPD obligations with specialists. Most of the feedback we received encouraged us to delegate processing responsibility and rely on the notion of legal bases. However, we feel that it is also our responsibility to encourage our end users to respect the processing of third-party data by offering a user experience that encourages the following of good practices.
