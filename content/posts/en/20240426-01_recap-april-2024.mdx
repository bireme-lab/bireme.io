...
tldr: "Over the past month, we have made great strides in the development of what we call \"the common base\" of our SaaS ecosystem: a platform for centralizing the management of users, organizations, billing parameters and, in general, everything that can be shared and distributed in a SaaS ecosystem."
---
...
**UX/UI :** All Heimdall V1 interfaces are now complete. Here are a few examples:
