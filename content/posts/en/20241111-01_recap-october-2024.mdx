...
seo:
  title: "Monthly recap for october 2024"
  description: "Check out Bireme Lab's October 2024 recap: major strategic refocus for Dédale, which becomes a distinct brand with a new business model. A comprehensive UI/UX redesign featuring a bento card system and development of a visual email editor inspired by Figma and Notion."
tldr: "In October 2024, we refocused our strategy at Bireme Lab by concentrating on Dédale, our email editor. We decided to evolve the product into a more accessible solution with a visual editor inspired by Figma and Notion, while preparing the transition to a paid model. Technical developments focused on integrating Tiptap for the visual editor. In parallel, we worked on a new landing page with a polished design, notably using light effects and bento cards."
---
