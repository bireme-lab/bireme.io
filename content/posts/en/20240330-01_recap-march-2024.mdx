...
- Rocket](https://rocket.rs/) makes it easy to create a web server that combines multi-threading and asynchronous code to create high-performance applications,
...
<sup>1</sup>: short for "Pull Request". C'est une fonctionnalité pour proposer et discuter des modifications de code avant de les fusionner avec le reste du projet<br />
