...
seo:
  title: "Monthly recap for september 2024"
  description: "Check out Bireme Lab's September 2024 recap: strategic overhaul, Hermes development with new domain and newsletter management features, and technical enhancements including an GDPR-compliant tracking option. A month rich in innovation and product-market alignment."
...
<Image
  src="/images/september-recap-bill-aulet-en.webp"
  alt="Focus on: Entrepreneurial discipline by Bill Aulet"
  title="Focus on: Entrepreneurial discipline by Bill Aulet"
  width={864}
  height={300}
  quality={100}
  style={{
...
To help us, we rely in part on the teachings of [Bill Aulet](https://mitsloan.mit.edu/faculty/directory/bill-aulet), **Executive Director of the Martin Trust Center for MIT Entrepreneurship at MIT**, in his book [“The Entrepreneurial Discipine: 24 Steps to Building a Successful Business”](https://www.d-eship.com/).
...
Both are [available for purchase on Amazon (FR)](https://www.amazon.fr/discipline-entrepreneuriale-%C3%A9tapes-d%C3%A9velopper-entreprise/dp/2212570511).

### Focus on: conducting discovery interviews

<Image
  src="/images/september-recap-interviews-illustration.webp"
  alt="Focus on: conducting discovery interviews"
  title="Focus on: conducting discovery interviews"
  width={864}
  height={300}
  quality={100}
  style={{
...
We were advised to read and apply the recommandations contained in the book [“The MOM test, how to talk to customers and learn if your business idea is a good one, when everyone is lying to you” (FR)](https://www.amazon.fr/Mom-Test-Comment-apprendre-dentreprise/dp/1724903861) by [Rob Fitzpatrick](https://www.robfitz.com/), a resource which we in turn recommend to those around us.
...
<Image
  ...
  alt="Focus on: tracking and escalating contacts' actions during mail communications"
  title="Focus on: tracking and escalating contacts' actions during mail communications"
  width={864}
  height={300}
  quality={100}
  style={{
...
- if `yes`, we store the event in our database, enabling us to compile statistics on the percentage of emails opened,
- if `no`, we ignore the message, preventing any possibility of retrieving this information in the future.

---

<sup>1</sup> : The Lean Startup is a methodology that aims to quickly create and develop businesses by continuously testing hypotheses with real customers, iteratively adapting the product, and minimizing risks and costs through short cycles of development and validation.
